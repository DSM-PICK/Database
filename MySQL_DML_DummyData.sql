...
INSERT INTO teacher(id, pw, name) VALUES('ccc', '2b83283b8caf7e952ad6b0443a87cd9ee263bc32c4d78c5b678ac03556175059679b4b8513b021b16a27f6d2a35484703129129f35b6cdfe418ef6473b1f8f23', '조규석');
INSERT INTO teacher(id, pw, name) VALUES('ddd', '3ba2942ed1d05551d4360a2a7bb6298c2359061dc07b368949bd3fb7feca3344221257672d772ce456075b7cfa50fd7ce41eaefe529d056bf23dd665de668b78', '안희명');
INSERT INTO teacher(id, pw, name) VALUES('eee', '4e83a3339059f0cc30910ae3ca1d01d854a0fefd2f277776e044daad540bbdd5c79033a1c2eb851dffd258194bd58f5657e93fa21b70b5180e7d0efc60040cd4', '서현철');
INSERT INTO teacher(id, pw, name) VALUES('fff', 'd1d7e84d9049900299ee9c0b2c04b11bfa9a0437afc0bf03d8ce0e3fb8523919f13fa3a5130c5ba7987679c6f6945ca87655e746eb5345bdc8131298fa5a9b20', '엄영석');
...
INSERT INTO activity(date, schedule, second_floor_teacher_id, third_floor_teacher_id, forth_floor_teacher_id) VALUES('2020-09-25', '동아리', 'aaa', 'bbb', 'ccc');
INSERT INTO activity(date, schedule, second_floor_teacher_id, third_floor_teacher_id, forth_floor_teacher_id) VALUES('2020-09-26', '주말', 'bbb', 'ccc', 'ddd');
INSERT INTO activity(date, schedule, second_floor_teacher_id, third_floor_teacher_id, forth_floor_teacher_id) VALUES('2020-09-27', '주말', 'ccc', 'ddd', 'eee');
INSERT INTO activity(date, schedule, second_floor_teacher_id, third_floor_teacher_id, forth_floor_teacher_id) VALUES('2020-09-28', '방과후', 'ddd', 'eee', 'fff');
INSERT INTO activity(date, schedule, second_floor_teacher_id, third_floor_teacher_id, forth_floor_teacher_id) VALUES('2020-09-29', '방과후', 'eee', 'fff', 'aaa');

INSERT INTO attendence(date, student_num, period, teacher_id, state) VALUES('2020-09-25', '2201', '8', 'aaa', '출석');
INSERT INTO attendence(date, student_num, period, teacher_id, state) VALUES('2020-09-25', '2201', '9', 'aaa', '출석');
INSERT INTO attendence(date, student_num, period, teacher_id, state) VALUES('2020-09-25', '2201', '10', 'aaa', '출석');

INSERT INTO attendence(date, student_num, period, teacher_id, state) VALUES('2020-09-25', '2202', '8', 'aaa', '출석');
INSERT INTO attendence(date, student_num, period, teacher_id, state) VALUES('2020-09-25', '2202', '9', 'aaa', '출석');
INSERT INTO attendence(date, student_num, period, teacher_id, state) VALUES('2020-09-25', '2202', '10', 'aaa', '출석');
